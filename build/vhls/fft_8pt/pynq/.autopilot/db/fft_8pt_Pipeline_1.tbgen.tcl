set moduleName fft_8pt_Pipeline_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {fft_8pt_Pipeline_1}
...
set portList { 
	...
	{ buffer_M_value_we0 sc_out sc_logic 1 signal 0 } 
	{ buffer_M_value_d0 sc_out sc_lv 32 signal 0 } 
	{ buffer_M_value_1_address0 sc_out sc_lv 3 signal 1 } 
	{ buffer_M_value_1_ce0 sc_out sc_logic 1 signal 1 } 
	{ buffer_M_value_1_we0 sc_out sc_logic 1 signal 1 } 
	{ buffer_M_value_1_d0 sc_out sc_lv 32 signal 1 } 
}
set NewPortList {[ 
